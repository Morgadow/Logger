...
class Logger(Borg):
    ...
    def __init__(self, loglvl='ERROR', projectname=None, createlogfile=False, logpath=None, addtimestamp=False, suppressloggernotes=False):
        ...
        # todo wenn neue instanz erstellt wird, dann werden auch alle attribute wieder von der neuen instanz �bernommen auf alle anderen
        # es sollen aber die alten attribute in die neue instanz mitgenommen werden und nicht anders herum
        # immerhin werden attribute wenn nicht ge�ndert auch beibehalten, nur wenn ge�ndert, dann wird die ver�nderung mitgenommen
